...
## Dataset
- We have released the images generated by the original SD1.5 and SD1.5-Realistic-Vision, which were used in the experiments for Figure 5. ([https://modelscope.cn/models/shuinishaojiu/PROBE-AIGI-Detection](https://modelscope.cn/models/shuinishaojiu/PROBE-AIGI-Detection))
